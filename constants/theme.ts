// Raw design tokens for use outside NativeWind (StyleSheet, inline styles,
// exception components like SafeAreaView/Modal — see AGENTS.md Style Exception Rules).
// These values must stay in sync with the `@theme` block in global.css.
